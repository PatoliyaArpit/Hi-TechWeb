...
const Profile = () => {
  ...
  const [togglecancle, settogglecancle] = useState(false);
  ...
  return (
    <>
      ...
      <Editpop  isOpen={isModalOpen} onClose={handleCloseModal}/>
      <PopBill isOpen={billpop } onClose={handleClosebill}/>
                  ...
                  <div className=" flex">
                    <div>
                      <a
                        ...
                        class="View"
                        onClick={() => {
                          setttoggleorder(!toggleorder)
                          settogglecancle(false)
                        }}
                      >
                        {toggleorder ? "Close" : " View Order"}
                      </a>
                    </div>
                    <div>
                      <a
                        ...
                        class="View"
                        onClick={() => {
                          settogglecancle(!togglecancle)
                          setttoggleorder(false)
                        }}
                      >
                        {togglecancle ? "Close" : " View Cancel Order"}
                      </a>
                    </div>
                  </div>
                  ...
                  {toggleorder ? (
                    <section className="vh-0 gradient-custom-2 scrollbar-hide ">
                      {FinalOrder.filter(
                        ...
                        (item) => item.Order_Status === "In progress"
                      ).map((val) => {
                        return (
                                  ...
                                  <div>
                                    ...
                                    <div className="card-body p-4">
                                      ...
                                      <ul
                                        ...
                                        className="mx-0 mt-0 mb-5 px-0 pt-0 pb-4"
                                      >
                                        <li className="step0 canceled" id="step1">
                                          <span
                                            style={{
                                              marginLeft: "22px",
                                              marginTop: "12px",
