...
const PDetails = () => {
  ...
  useEffect(() => {
    if (state.LoginId !== null) {
      const Finalcart = cartdata.filter((val) => val.UserId === state.LoginId);
              ...
              <main className="col-lg-6">
                <div className="ps-lg-3">
                  ...
                  <div className="row">
                    ...
                    <dd className="col-9">{state.Type}</dd>
                    <dt className="col-3">Color</dt>
                    <dd className="col-9">{state.Color}</dd>
                    <dt className="col-3">Material</dt>
                    <dd className="col-9">{state.Material}</dd>
                    <dt className="col-3">Brand</dt>
                    <dd className="col-9">{state.Brand}</dd>
                  </div>
                  <hr />
                  ...
                  {cartcheck.includes(state.Title) ? (
                      ...
                      <table className="table border mt-3 mb-2">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td className="py-2">{state.Capacity}</td>
                          </tr>
                          {/* <tr>
